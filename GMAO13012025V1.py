...
base_path = "C:\\Users\\fer1cas\\OneDrive - Bosch Group\\GMAO TEST"  # Remplacez  par le chemin souhaité
...
def create_client():
    ...
    base_path = "C:\\Users\\fer1cas\\OneDrive - Bosch Group\\GMAO TEST"
...
def add_document(doc_type):
    ...
    if doc_type == "BC_service" or doc_type == "BC_PDR":
        ...
        offer_path = os.path.join("C:\\Users\\fer1cas\\OneDrive - Bosch Group\\GMAO TEST", classification, payee_name, client_name, offer_month, offer_type)
        ...
        if st.button(f'Ajouter le/la {doc_type}'):
            if doc_file:
                save_path = os.path.join(
                    "C:\\Users\\fer1cas\\OneDrive - Bosch Group\\GMAO TEST", classification, payee_name, client_name, month, doc_type, doc_file.name
                )
            ...
            for client in selected_clients:
                for month in range(int(start_month), int(end_month) + 1):
                    ...
                    for classification in ['Sacofrina', 'Others']:
                        doc_path = os.path.join("C:\\Users\\fer1cas\\OneDrive - Bosch Group\\GMAO TEST", classification, payee, client, month_str, doc_type)
